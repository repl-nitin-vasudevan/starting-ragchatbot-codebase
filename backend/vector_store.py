...
class SearchResults:
    ...
    def empty(cls, error_msg: str) -> "SearchResults":
        ...
        return cls(
            documents=[], metadata=[], distances=[], error=error_msg, source_links=[]
        )
...
class VectorStore:
    ...
    def __init__(self, chroma_path: str, embedding_model: str, max_results: int = 5):
        ...
        try:
            ...
            print(
                "✓ Using ChromaDB default embedding function (no external downloads required)"
            )
